...
public class RealEstatePurchaseFeesTest {
    ...
    public void should_return_notary_cost_part(){
        final RealEstatePurchaseFees realEstatePurchaseFees = RealEstatePurchaseFees.buildFrom(500000, "95240");
    ...
    public void should_return_dmto_cost_part(){
        final RealEstatePurchaseFees realEstatePurchaseFees = RealEstatePurchaseFees.buildFrom(500000, "95240");
        Assert.assertEquals(0, Double.compare(realEstatePurchaseFees.getDetails().totalTax, 29050));
    }
}